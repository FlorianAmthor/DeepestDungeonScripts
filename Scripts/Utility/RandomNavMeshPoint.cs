    ...
    */
    ...
    public class RandomNavMeshPoint : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            triangleArea = new float[nav.areas.Length];

            totalArea = 0.0f;
            for (int i = 0; i < mesh.triangles.Length / 3; i++)
            {
                totalArea += triangleArea[i] = GetTriangleArea(i);
            }
        }
