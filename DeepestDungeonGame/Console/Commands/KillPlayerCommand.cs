...
{
    internal class KillPlayerCommand : ConsoleCommand
    {
        internal KillPlayerCommand()
        {
            Name = "Kill Player";
            Command = "kill";
            ...
            FailureReturnText = "Killing Failed: Only the master client can kill other players.";
            TakesArguments = true;
        }
        ...
        internal override string RunCommand(string[] args)
        {
            ...
            {
                networkPlayer.photonView.RPC("TakeDamage", RpcTarget.All, 20000, -1);
